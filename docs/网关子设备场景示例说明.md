# 网关子设备场景示例说明  
本文档将讲述如何在腾讯物联网开发平台(IoT Explorer)控制台申请网关设备并绑定子设备, 并通过C-SDK中的**[gateway_sim_sample](../samples/scenarized/gateawy_sim_sample.c)**，展示网关设备如何管理子设备**subdev_sim_sample**，并代理子设备的上下行消息。  
