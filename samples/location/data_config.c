...
typedef struct _StructDefineGps_Info {
    TYPE_DEF_TEMPLATE_FLOAT m_longitude;
...
{
    // WGS84
    sg_StructDataGps_Info.m_longitude               = 108.884031;
    sg_StructTemplateGps_Info[0].data_property.data = &sg_StructDataGps_Info.m_longitude;
    sg_StructTemplateGps_Info[0].data_property.key  = "longitude";
