...
static void _init_data_template(void)
{
    ...
    sg_DataTemplate[1].data_property.data_buff_len =
        sizeof(sg_ProductData.m_cur_play_list) / sizeof(sg_ProductData.m_cur_play_list[0]);
    ...
    sg_DataTemplate[6].data_property.data_buff_len =
        sizeof(sg_ProductData.m_cur_song_id) / sizeof(sg_ProductData.m_cur_song_id[0]);
