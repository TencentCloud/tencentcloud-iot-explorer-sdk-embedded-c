...
{
    DataTemplate *pTemplateData = (DataTemplate *)IOT_Template_Get_DataTemplate(pClient);
    ProductDataDefine *pProductPara = container_of(#To generate Get Product Parameter);
