...
ifeq (y, $(strip $(FEATURE_DATA_TEMPLATE_ENABLED)))
CFLAGS += -DDATA_TEMPLATE_ENABLED
endif

ifeq (y, $(strip $(FEATURE_ACTION_ENABLED)))
CFLAGS += -DACTION_ENABLED
endif
...
ifeq (y, $(strip $(FEATURE_DEBUG_DEV_INFO_USED)))
CFLAGS += -DDEBUG_DEV_INFO_USED
endif
