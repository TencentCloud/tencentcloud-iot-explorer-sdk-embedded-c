...
#ifndef QLCOUD_IOT_EXPORT_LOCATION_H_
#define QLCOUD_IOT_EXPORT_LOCATION_H_
...
/**
 * @brief Register a callback function to receive the electric fence aleart
 ...
 *
 * @param mqtt_client the mqtt client
 * @param client_token reply client token
 * @param reply_code 0 is success
 * @param reply_msg success or others
 * @return QCLOUD_RET_SUCCESS for success, or err code for failure
 */
