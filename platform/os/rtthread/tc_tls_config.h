 ...
 * provide
 * the other function (using your mbedtls_sha1_process() function) and the
 * definition
 * of mbedtls_sha1_context, so your implementation of mbedtls_sha1_process must
 * be compatible
 * with this definition.
 *
 * \note Because of a signature change, the core AES encryption and decryption
 * routines are
 *       currently named mbedtls_aes_internal_encrypt and
 * mbedtls_aes_internal_decrypt,
 *       respectively. When setting up alternative implementations, these
 * functions should
 *       be overriden, but the wrapper functions mbedtls_aes_decrypt and
 * mbedtls_aes_encrypt
 *       must stay untouched.
 *
...
// used per seed by default (48 with SHA-512, 32 with SHA-256) */
//#define MBEDTLS_CTR_DRBG_RESEED_INTERVAL        10000 /**< Interval before
// reseed is performed by default */
//#define MBEDTLS_CTR_DRBG_MAX_INPUT                256 /**< Maximum number of
// additional input bytes */
//#define MBEDTLS_CTR_DRBG_MAX_REQUEST             1024 /**< Maximum number of
// requested bytes per call */
//#define MBEDTLS_CTR_DRBG_MAX_SEED_INPUT           384 /**< Maximum size of
//(re)seed buffer */

/* HMAC_DRBG options */
//#define MBEDTLS_HMAC_DRBG_RESEED_INTERVAL   10000 /**< Interval before reseed
// is performed by default */
//#define MBEDTLS_HMAC_DRBG_MAX_INPUT           256 /**< Maximum number of
// additional input bytes */
//#define MBEDTLS_HMAC_DRBG_MAX_REQUEST        1024 /**< Maximum number of
// requested bytes per call */
//#define MBEDTLS_HMAC_DRBG_MAX_SEED_INPUT      384 /**< Maximum size of
//(re)seed buffer */
...
// sources supported */
//#define MBEDTLS_ENTROPY_MAX_GATHER                128 /**< Maximum amount
// requested from entropy sources */
...
// needed. */
//#define MBEDTLS_PLATFORM_STD_CALLOC        calloc /**< Default allocator to
...
// can be undefined. MBEDTLS_HAVE_TIME must be enabled */
...
// use, can be undefined */
//#define MBEDTLS_PLATFORM_STD_EXIT_SUCCESS       0 /**< Default exit value to
// use, can be undefined */
//#define MBEDTLS_PLATFORM_STD_EXIT_FAILURE       1 /**< Default exit value to
// use, can be undefined */
...
//#define MBEDTLS_PLATFORM_FREE_MACRO            free /**< Default free macro to
// use, can be undefined */
//#define MBEDTLS_PLATFORM_EXIT_MACRO            exit /**< Default exit macro to
// use, can be undefined */
//#define MBEDTLS_PLATFORM_TIME_MACRO            time /**< Default time macro to
// use, can be undefined. MBEDTLS_HAVE_TIME must be enabled */
//#define MBEDTLS_PLATFORM_TIME_TYPE_MACRO       time_t /**< Default time macro
// to use, can be undefined. MBEDTLS_HAVE_TIME must be enabled */
//#define MBEDTLS_PLATFORM_FPRINTF_MACRO      fprintf /**< Default fprintf macro
// to use, can be undefined */
//#define MBEDTLS_PLATFORM_PRINTF_MACRO        printf /**< Default printf macro
// to use, can be undefined */
/* Note: your snprintf must correclty zero-terminate the buffer! */
...
// mbedtls_platform_std_nv_seed_write /**< Default nv_seed_write function to use,
// can be undefined */
...
/* SSL options */
//#define MBEDTLS_SSL_MAX_CONTENT_LEN             16384 /**< Maxium fragment
// length in bytes, determines the size of each of the two internal I/O buffers
//*/
...
// keys, in bytes (default 256 bits) */
...
//#define MBEDTLS_X509_MAX_FILE_PATH_LEN     512 /**< Maximum length of a
